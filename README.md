...
- Keep a separate CPU-full Vision Mamba-style baseline that preserves bidirectional state-space sequence mixing for local comparison runs without overwriting the Linux/CUDA Vim path.
